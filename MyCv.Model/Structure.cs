...
public record struct SideStructure(
    [Required] MyPrintCv MyPrintCv,
    MyWebCv MyWebCv,
    OtherSide[] Sides,
...
public record struct CvSection(
    [Required] string Title,
    CvSkill[]? Skills = null,
    CvEntry[]? Entries = null,
    CvSection[]? SubSections = null);

public record struct CvEntry(
    [Required] string TimePeriod,
    [Required] string Text,
    string? ShortTitle = null,
    string? Additional = null,
    bool NewLineToBr = false);

public record struct CvSkill([Required] string Text);

public record struct CvPersonalImage(
